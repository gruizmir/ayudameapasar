...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlumnoAyudantia.ayudante_evaluo'
        db.add_column(u'ayudantias_alumnoayudantia', 'ayudante_evaluo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AlumnoAyudantia.alumno_evaluo'
        db.add_column(u'ayudantias_alumnoayudantia', 'alumno_evaluo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AlumnoAyudantia.fecha_realizacion'
        db.add_column(u'ayudantias_alumnoayudantia', 'fecha_realizacion',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2013, 12, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlumnoAyudantia.ayudante_evaluo'
        db.delete_column(u'ayudantias_alumnoayudantia', 'ayudante_evaluo')

        # Deleting field 'AlumnoAyudantia.alumno_evaluo'
        db.delete_column(u'ayudantias_alumnoayudantia', 'alumno_evaluo')

        # Deleting field 'AlumnoAyudantia.fecha_realizacion'
        db.delete_column(u'ayudantias_alumnoayudantia', 'fecha_realizacion')
    ...
    models = {
        ...
        u'ayudantias.alumnoayudantia': {
            ...
            'alumno_evaluo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'asistio': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'ayudante_evaluo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'fecha_realizacion': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
