...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ayudantia.fecha_termino'
        db.add_column(u'ayudantias_ayudantia', 'fecha_termino',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 20, 0, 0)),
                      keep_default=False)


        # Changing field 'HorarioAyudantia.dia'
        db.alter_column(u'ayudantias_horarioayudantia', 'dia', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Deleting field 'Ayudantia.fecha_termino'
        db.delete_column(u'ayudantias_ayudantia', 'fecha_termino')


        # Changing field 'HorarioAyudantia.dia'
        db.alter_column(u'ayudantias_horarioayudantia', 'dia', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'ayudantias.ayudantia': {
            ...
            'fecha_termino': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
