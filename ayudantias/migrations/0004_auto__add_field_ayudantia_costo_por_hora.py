...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ayudantia.costo_por_hora'
        db.add_column(u'ayudantias_ayudantia', 'costo_por_hora',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ayudantia.costo_por_hora'
        db.delete_column(u'ayudantias_ayudantia', 'costo_por_hora')
