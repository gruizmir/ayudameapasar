...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ayudantias_categoria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50L)),
        ))
        db.send_create_signal(u'ayudantias', ['Categoria'])

        # Adding model 'Subcategoria'
        db.create_table(u'ayudantias_subcategoria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=50L)),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ayudantias.Categoria'])),
        ))
        db.send_create_signal(u'ayudantias', ['Subcategoria'])

        # Adding model 'Ayudantia'
        db.create_table(u'ayudantias_ayudantia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ayudantias.Categoria'], null=True, blank=True)),
            ('subcategoria', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['ayudantias.Subcategoria'], null=True, blank=True)),
        ))
        db.send_create_signal(u'ayudantias', ['Ayudantia'])

        # Adding model 'HorarioAyudantia'
        db.create_table(u'ayudantias_horarioayudantia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('hora_final', self.gf('django.db.models.fields.TimeField')()),
            ('dia', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('activo', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'ayudantias', ['HorarioAyudantia'])

        # Adding model 'AlumnoAyudantia'
        db.create_table(u'ayudantias_alumnoayudantia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alumno', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('ayudantia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ayudantias.Ayudantia'])),
            ('horario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ayudantias.HorarioAyudantia'])),
            ...
            ('cantidad_personas', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'ayudantias', ['AlumnoAyudantia'])


    def backwards(self, orm):
        # Deleting model 'Categoria'
        db.delete_table(u'ayudantias_categoria')

        # Deleting model 'Subcategoria'
        db.delete_table(u'ayudantias_subcategoria')

        # Deleting model 'Ayudantia'
        db.delete_table(u'ayudantias_ayudantia')

        # Deleting model 'HorarioAyudantia'
        db.delete_table(u'ayudantias_horarioayudantia')

        # Deleting model 'AlumnoAyudantia'
        db.delete_table(u'ayudantias_alumnoayudantia')
    ...
    models = {
        ...
        u'ayudantias.horarioayudantia': {
            ...
            'ayudantia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ayudantias.Ayudantia']"}),
            'dia': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
