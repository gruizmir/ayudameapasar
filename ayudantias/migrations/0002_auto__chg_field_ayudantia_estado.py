...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ayudantia.estado'
        db.alter_column(u'ayudantias_ayudantia', 'estado', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Ayudantia.estado'
        db.alter_column(u'ayudantias_ayudantia', 'estado', self.gf('django.db.models.fields.IntegerField')())
